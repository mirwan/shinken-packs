...
#
%define raw_name    fail2ban-collectd
%define name        fail2ban-collectd
...
License: GPL v3
Summary: Shinken plugin. Fail2ban passive checks based on Collectd
...
%description 
Shinken plugin. Fail2ban passive checks based on Collectd
...
%changelog
* Thu May 05 2015 Erwan Miran <mirwan666@gmail.com>
- Initial Release
